package cn.coselding.netspider.spider.http;
...
public class OKHttp {
	...
	public void getImage(String url, String imagePath) throws IOException {
		...
		IOUtils.copy(this.mHTTP.newCall(localRequest).execute().body()
				.byteStream(), fos);
		fos.close();
	}
